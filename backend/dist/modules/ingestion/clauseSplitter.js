...
exports.ClauseSplitter = void 0;
const hasher_1 = require("../../utils/hasher");
const security_1 = require("../../utils/security");
class ClauseSplitter {
    static CLAUSE_PATTERNS = [
    ...
    static split(documentText) {
        ...
        workingChunks.forEach((chunk, idx) => {
            ...
            const sanitized = security_1.SecurityGuard.sanitizeInput(chunk);
            const hash = hasher_1.Hasher.sha256(sanitized);
            parsedClauses.push({
                index: idx,
                clauseType,
                originalText: chunk,
     ...
     */
    static classifyClause(clauseText) {
...
exports.ClauseSplitter = ClauseSplitter;
